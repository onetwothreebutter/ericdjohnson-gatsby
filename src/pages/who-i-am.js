...
//styles
import whoIAmStyles from '../page-assets/who-i-am/styles/who-i-am.sass'

//images
import ruralNerdImage from '../page-assets/who-i-am/images/rural-nerd.jpg'


class WhoIAmPage extends React.Component {
            ...
            <div>
                <section className="who-banner">
                    <div className="site__page-width">
                        <AnimatedHeading headingText="Who I Am" headingClassName="who-banner__heading"/>
                        <PhotoCredit name="Kristopher Roller"
                ...
                <section className="site__section">
                    <p className="site__paragraph-text">
                        ...
                        responsibility, and the environment. I've been a web developer
                        for {(new Date()).getFullYear() - 2006} years, and for the past {telecommute_years} years I've been
                        telecommuting from an acreage outside Iowa City, where my wife and I grow
                        pick-your-own blueberries. We are also the stewards of two rambunctious llamas, <a
                        className="site__paragraph-link" href="https://twitter.com/llama_jake"
                        target="_blank">Jake</a> and <a
                        className="site__paragraph-link" href="https://twitter.com/llama_elwood" target="_blank">Elwood</a>,
                        and we're renovating our 100-year
                        old
                    ...
                    <p className="site__paragraph-text">
                        ...
                        tractors and
                        baling hay, and I rode our farm's old blue ATV like I was competing in the X Games. But I alse loved
                        computers.
                        My family got our first computer in 1990. It had a 20 mHz processor, and one of the greatest
                        presents I got was
                        a SoundBlaster sound card. I was totally a rural nerd.

                    </p>
                    <img className="who-i-am__image" src={ruralNerdImage} alt="Eric showcasing his middle school art"/>

                    <h2 className="site__section-heading">Open-minded</h2>
                    <p className="site__paragraph-text">
                        I've made several reversals in my life when I have encountered compelling evidence to change. I used
                        to believe
                        running would lead to some kind of crippling injury, and I even bought an elliptical machine to
                        protect my joints. But
                        then I read <span className="site__book-title">Born to Run</span> by Christopher McDougall, which
                        details evidence
                        that humans actually evolved to be great long-distance runners. (Did you know humans can beat a
                        horse in a marathon?)
                        Now I run several times a week cross-country for exercise, and I own a treadmill.
                    </p>
                    <p className="site__paragraph-text">
                        I'm also OK with being wrong. I feel like it's better to stick my neck out and and suggest an idea
                        than it is to
                    ...
                    <p className="site__paragraph-text">
                        ...
                        Part of the reason I like co-leading our local chapter of Citizens' Climate Lobby is that CCL's
                        approach involves
                        having civil, respectful conversations with Democrats and Republicans about climate change. And I
                        have a pet
                    ...
                    <p className="site__paragraph-text">
                        ...
                        when someone interrupts another person, but when I notice it, I wait for the current speaker to
                        finish and then
                    ...
                    <p className="site__paragraph-text">
                        ...
                        designs, both for the web and otherwise (my hobby business is designing funny t-shirts and
                        stickers). It's
                    ...
                    <ul className="site__ol-or-ul-list">
                        <li className="site__list-item">I’m the co-leader of the Iowa City chapter of <a
                            ...
                            at the federal level. I lead and organize monthly meetings and help chapter members write
                            letters and meet
                            with Iowa’s Senators and Representatives.
                        </li>
                        <li className="site__list-item">In Spring 2017, I organized a <a className="site__paragraph-link"
                                                                                         href="https://runforvictimsofclimatechange.org/"
                                                                                         target="_blank">run/walk
                            fundraiser</a> for climate change victims.
                            We had 71 registrants and raised over $2,300 for the American Red Cross's Disaster Relief Fund.
                        </li>
                        <li className="site__list-item">I served on the Wellness Committee and the Coolness Committee at my
                            previous
                            job at Integrated DNA Technologies. We created a "Thinnest Winner" contest for weight loss (my
                            name!), and
                            helped plan office overhauls to modernize our workplace.
                        </li>
                    </ul>
                    ...
                    <div className="site__paragraph-text">
                        <ul className="site__ol-or-ul-list">
                            <li className="site__list-item">I love baseball and once led a co-ed slow-pitch softball team
                                called the Monster Ballads.
                            </li>
                            <li className="site__list-item">I say "pop" instead of "soda" but don't drink either anymore.
                            </li>
                            <li className="site__list-item">I have a <a className="site__paragraph-link"
                                                                        href="https://onewheel.com/"
                                                                        target="_blank">Onewheel+</a> and I love it to
                                death!
                            </li>
