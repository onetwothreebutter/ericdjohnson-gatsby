        ...
        <div>
            <section className="who-banner">
                <div className="site__page-width">
                    ...
                    <PhotoCredit name="Kristopher Roller" image_url="http://unsplash.com/@krisroller?utm_medium=referral&amp;utm_campaign=photographer-credit&amp;utm_content=creditBadge"/>
                </div>
            </section>
            <section className="site__section">
                <p className="site__paragraph-text">
                    ...
                    responsibility, and the environment. I've been a web developer for { (new Date()).getFullYear() - 2006 } years, and for the past { telecommute_years } years I've been
                    telecommuting from an acreage outside Iowa City, where my wife and I grow
                    pick-your-own blueberries. We are also the stewards of two rambunctious llamas, <a className="site__paragraph-link" href="https://twitter.com/llama_jake" target="_blank">Jake</a> and <a
                    className="site__paragraph-link" href="https://twitter.com/llama_elwood" target="_blank">Elwood</a>, and we're renovating our 100-year
                    old
                ...
                <p className="site__paragraph-text">
                    ...
                    then I read <span className="site__book-title">Born to Run</span> by Christopher McDougall, which details evidence
