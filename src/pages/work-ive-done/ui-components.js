    ...
    return (
        <div>
            ...
            <section className="site__section">
                ...
                <p className="site__paragraph-text">I designed and coded this button, but it was inspired by this <a href="https://codepen.io/shshaw/pen/BxLbqO/">@keyframers codepen/episode</a>. I decided to deviate from the approach used in the @keyframers codepen, and instead, animate CSS clip-path to create the aperture effect.
                </p>
