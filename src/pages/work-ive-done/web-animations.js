        ...
        return (
            <div>
                <section className="web-animations-banner">
                    <h1 className="web-animations-banner__heading">
                        Web Animations
                    </h1>
                </section>

                <section className="site__section">
                    <p className="site__paragraph-text">I've got a knack for visualizing how a static design can be
                        animated.
                ...
                <section className="site__section">
                    ...
                    <p className="site__paragraph-text">At Cornerstone, our marketing website needed to feel more alive,
                        personable, and less stock-photo-y.
                        To address this, the designers wanted custom SVG icons to be animated as the user scrolled over
                        them. I was given the static design and I
                    ...
                    <div className="work-example__button-container">
                        <a className="site__button" href="http://codepen.io/collection/DyVgBV/" target="_blank">Full
                            Collection on Codepen</a>
                    </div>
                </section>
                ...
                <section className="site__section">
                    ...
                    <p className="site__paragraph-text">I love Cornerstone's 2016 conference logo. Its vibrant rainbow
                        colors
                    ...
                    <iframe className="work-example__iframe" width="560" height="315"
                ...
                <section className="site__section">
                    ...
                    <p className="site__paragraph-text">Our design team created a "product wheel" to illustrate how our
                        products fit together and cover the employee lifecycle (hiring, learning, performance review,
                        etc).
                ...
                <section className="site__section">
                    ...
                    <p className="site__paragraph-text">
                        Cornerstone's CEO wanted a fun and lively webpage describing the company's journey from startup
                        to IPO. Our creative director handed
                        me a static Photoshop file and I ran with it. I designed and coded the animations using
                        ScrollMagic and GreenSock.
                    </p>
                    <p className="site__paragraph-text">
                        Here's a quick screencast of a user scrolling through the page (for this demo, I refactored the
                        page to remove company-specific information and added some fun fake companies).
                    </p>

                    <VideoElement mp4={foundersMp4} webm={foundersWebm}/>

                    <div className="work-example__button-container">
                        <a className="work-example__button" href="https://codepen.io/ericdjohnson/project/live/AwknqA"
                           target="_blank">Live Codepen
                            demo</a>
                    </div>
