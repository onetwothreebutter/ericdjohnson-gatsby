...
//styles
import uxDesignStyles from '../../page-assets/work-ive-done/subpages/ux-design/styles/ux-design.sass'
...
const UXDesign = () => (
    ...
    <div>
        <section className="ux-design-banner">
            <h1 className="ux-design-banner__heading">
                UX Design
            </h1>
        </section>

        <section className="site__section">
            <p className="site__paragraph-text">Although I'm not a full-time user experience designer, I care strongly about UX. When I come across UX issues
        ...
        <hr className="section-divider"/>
            ...
            <h2 className="site__section-heading">The Case of the Wrong Audience</h2>
        <p className="site__paragraph-text">I received a comp from the design team for a page
        ...
        <section className="site__section">
            <div className="site__page-width">
                <h2 className="site__section-heading">The Case of Unscannable Content</h2>
                <p className="site__paragraph-text">The below web page lists all its information resources in a
                    randomized tile format. These include several different types of resources (webinars, infographics, briefs, etc.).
                </p>

                <ZoomableImage img={resourceCenterCurrent} alt="Resource Center without organization"/>

                <p className="site__paragraph-text">I felt that the information cards on the page were hard to scan. The only way
                ...
                <ZoomableImage img={resourceCenterConcept} alt="Resource Center after organization"/>

                <p className="site__paragraph-text">
                    This format also makes it easier for the user to re-browse to the same piece of content, and to easily tell if new content of a particular type has been added.
                </p>
