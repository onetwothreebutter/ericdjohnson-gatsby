...
//styles
import writingStyles from '../../page-assets/work-ive-done/subpages/writing/styles/writing.sass'
    ...
    <div>
        ...
        <section className="site__section">
            <blockquote className="site__blockquote">
                “Even when you're writing code explicitly intended for the machine, you're still writing. For other
                people. Fallible, flawed, distracted human beings just like you. And that's the truly difficult part.”
                <cite className="site__cite">&ndash; Jeff Atwood, Co-founder, Stack Overflow</cite>
            </blockquote>

            <p className="site__paragraph-text">I value good writing, and I strive to write well, whether it's emails to friends
                and colleagues, or op-eds to newspapers and magazines.
                I believe my writing skills help me write better code that's easy to understand and modify. During code
                reviews I often suggest ways to make code
                more readable, and I enjoy refactoring my own code to make it simpler.
            </p>
            <p className="site__paragraph-text">
                Below are some writing samples that provide an example of my voice, my personality, and my critical thinking skills.</p>
        </section>

        <section className="site__section">
            <h2 className="site__section-heading">Press Release</h2>
            <p className="site__paragraph-text">
                <a className="news-item" href="https://runforvictimsofclimatechange.files.wordpress.com/2016/10/barbaraschlachter5kpressrelease.pdf">
                    <figure>
                        <img className="news-item__thumbnail" src={runWalkPressRelease} alt="Screenshot of the Run/Walk for Climate Change Press Release"/>
                        <figcaption className="news-item__title">Barbara Schlachter Run/Walk for Victims of Climate Change</figcaption>
                    </figure>
                </a>
            </p>
        </section>
...
">
                    <figure>
                        <img className="news-item__thumbnail" src={firstStepOpEd} alt="Photo of First Step Toward Climate Action op-ed"/>
                        <figcaption className="news-item__title">Take your first step toward climate action this Earth Day
                        </figcaption>
                    </figure>
                </a>

                <a className="news-item -climate-march" href="http://www.press-citizen.com/story/opinion/contributors/guest-editorials/2014/09/16/time-join-iowa-city-peoples-climate-march/15698613/
">
                    <figure>
                        <img className="news-item__thumbnail" src={iowaCityClimateMarchOpEd} alt="Photo of Iowa City Climate March op-ed"/>
                        <figcaption className="news-item__title">Time to join the Iowa City people's climate march</figcaption>
                    </figure>
                </a>
                ...
                <a className="news-item"
                   href="http://www.press-citizen.com/story/opinion/contributors/guest-editorials/2016/04/20/climate-change-security-risk/83290412/">
                    <figure>
                        <img className="news-item__thumbnail" src={securityRiskOpEd} alt="Photo of Climate Change is a Security Risk op-ed"/>
                        <figcaption className="news-item__title">Climate change is a security risk</figcaption>
                    </figure>
                </a>
                ...
                <a className="news-item"
                   href="http://www.press-citizen.com/story/opinion/contributors/guest-editorials/2016/10/19/fee-and-dividend-plan-would-curb-climate-change/92416366/">
                    <figure>
                        <img className="news-item__thumbnail" src={feeDividendOpEd} alt="Photo of Fee and Dividend op-ed"/>
