...
import skillsIHave from '../page-assets/skills-i-have/js/skills-i-have'
...
const SkillsIHavePage = () => (
    <div>
        <section className="skills-banner">
            ...
            <img className="skills-banner__water-effect-target-image" src={waterEffectImage}/>

        </section>
        <section className="site__section">
            <div className="site__page-width">
                <h2 className="site__section-heading">Web Skills</h2>
                <p className="site__paragraph-text">I have a BS in Computer Science from the University of Iowa and have been a
                    professional web developer for { (new Date()).getFullYear() - 2006 } years.

                </p>
                <p className="site__paragraph-text">
                    Below is a list of my relative proficiency in different technologies.
                </p>
                <fieldset className="web-skills__scale">
                    <legend className="web-skills__scale-heading">Skill Scale</legend>
                    <dl className="web-skills__legend">
                        <dt className="web-skills__scale-name">Beginner:</dt><dd className="web-skills__scale-definition"><div className="proficiency--beginner"></div>I've used this technology to build something at least once.</dd>
                        <dt className="web-skills__scale-name">Comfortable:</dt><dd className="web-skills__scale-definition"><div className="proficiency--comfortable"></div>I've used this technology several times and have a decent feel for it.</dd>
                        <dt className="web-skills__scale-name">Very Comfortable:</dt><dd className="web-skills__scale-definition"><div className="proficiency--master"></div>I could teach a class on this topic!</dd>
                    </dl>
                </fieldset>
                <ul className="web-skills__skill-list">
                    <li className="web-skills__skill-item">
                        CSS/Sass
                        <div className="proficiency--master"></div>
                    </li>
                    <li className="web-skills__skill-item">
                        SVG
                        <div className="proficiency--comfortable"></div>
                    </li>
                    <li className="web-skills__skill-item -javascript">JS
                        <ul className="web-skills__skill-sublist">
                            <li className="web-skills__skill-item">Regular JS
                                <div className="proficiency--master"></div>
                            </li>
                            <li className="web-skills__skill-item">jQuery
                                <div className="proficiency--master"></div>
                            </li>
                            <li className="web-skills__skill-item">Angular 1
                                <div className="proficiency--beginner"></div>
                            </li>
                            <li className="web-skills__skill-item">React
                                <div className="proficiency--beginner"></div>
                            </li>
                            <li className="web-skills__skill-item">GreenSock
                                <div className="proficiency--comfortable"></div>
                            </li>
                        </ul>
                    </li>
                    <li className="web-skills__skill-item">Elm
                        <div className="proficiency--beginner"></div>
                    </li>
                    <li className="web-skills__skill-item">PHP
                        <div className="proficiency--master"></div>
                    </li>
                    <li className="web-skills__skill-item">Drupal
                        <div className="proficiency--master"></div>
                    </li>
                </ul>
                <div className="web-skills__asterisk">
                </div>
                <p className="site__paragraph-text">
                    I maintain and improve my coding skills by using a variety of tools and materials. I train on <a className="site__paragraph-link" href="https://www.codewars.com/users/ericdjohnson" target="_blank">Codewars</a>
                    and <a className="site__paragraph-link" href="https://codefights.com/profile/ericdjohnson_ia" target="_blank">CodeFights</a>. I read books on programming like <span className="site__book-title">Clean Code</span> and <span className="site__book-title">The Pragmatic Programmer</span>.
                </p>
                <p className="site__paragraph-text">
                    I also subscribe to <a className="site__paragraph-link" href="https://frontendmasters.com/" target="_blank">Frontend Masters</a> so I can dive deeply into new technologies quickly. The courses range from 5 hours to 10 hours in length, but I usually spend double that coding the examples and creating flashcards of the material.
                    <a className="web-course" href="https://frontendmasters.com/courses/elm/">
                        <img className="web-course__image" src={elmCourseImage}/>
                    </a>
                    <a className="web-course" href="https://frontendmasters.com/courses/svg-animation/">
                        <img className="web-course__image" src={svgAnimationImage}/>
                    </a>
                    <a className="web-course" href="https://frontendmasters.com/courses/good-parts-javascript-web/">
                        <img className="web-course__image" src={jsGoodPartsImage}/>
                    </a>
                    <a className="web-course" href="https://frontendmasters.com/courses/react-intro/">
        ...
        <section className="site__section">
            ...
            <ul className="site__ol-or-ul-list">
                <li className="site__list-item">I try to reduce the number of emails required to reach a decision or convey information by summarizing long email
                    chains, and by asking multiple choice questions instead of open-ended questions (when appropriate).</li>
                <li className="site__list-item">I'm aware of my audience and I adjust my language and jargon accordingly.</li>
                <li className="site__list-item">I convey my uncertainty when I'm not sure about something
                    and ask for other's input when warranted.</li>
                <li className="site__list-item">I'm honest about weaknesses in my ideas (and other's ideas).</li>
                <li className="site__list-item">I use screenshots and screencasts to capture information and context when it would be harder to
        ...
        <section className="site__section">
            ...
            <p className="site__paragraph-text">
                And according to <a className="site__book-title" href="http://a.co/1qULY7R" target="_blank">Deep Work</a> by Cal Newport, the way we focus
        ...
        <section className="site__section">
            ...
            <p className="site__paragraph-text">
                At a team retreat, my company hired <a className="site__paragraph-link" href="http://futurethink.com/" target="_blank">FutureThink</a> to improve our
        ...
        <section className="site__section">
            ...
            <p className="site__paragraph-text">
                Last year I participated in two <a className="site__paragraph-link" href="https://startupweekend.org/" target="_blank">Startup Weekends</a>,
                ...
                led to our winning free tuition to the University of Iowa's six-week <a className="site__paragraph-link" href="https://iowajpec.org/entrepreneur-support/venture-school/" target="_blank">Venture School</a> at the Pappajohn Entrepreneurial Center.
            </p>
            <p className="site__paragraph-text">In Venture School, my team and I conducted over 70 customer
