      ...
      <Layout>
        ...
        <section className="site__section">
          <div className="site__page-width">
            ...
            <p className="site__paragraph-text">
              Below is a list of my relative proficiency in different
              technologies.
            </p>
            <fieldset className="web-skills__scale">
              ...
              <dl className="web-skills__legend">
                <dt className="web-skills__scale-name">Beginner:</dt>
                <dd className="web-skills__scale-definition">
                  <div className="proficiency--beginner"></div>I've used this
                  technology to build something at least once.
                </dd>
                <dt className="web-skills__scale-name">Comfortable:</dt>
                <dd className="web-skills__scale-definition">
                  <div className="proficiency--comfortable"></div>I've used this
                  technology several times and have a decent feel for it.
                </dd>
                <dt className="web-skills__scale-name">Very Comfortable:</dt>
                <dd className="web-skills__scale-definition">
                  <div className="proficiency--master"></div>I could teach a
                  class on this topic!
                </dd>
              </dl>
            </fieldset>
            <ul className="web-skills__skill-list">
              ...
              <li className="web-skills__skill-item -javascript">
                JS
                <ul className="web-skills__skill-sublist">
                  ...
                  <li className="web-skills__skill-item">
                    Angular 1<div className="proficiency--beginner"></div>
                  </li>
                  <li className="web-skills__skill-item">
                    React
            ...
            <div className="web-skills__asterisk"></div>
            <p className="site__paragraph-text">
